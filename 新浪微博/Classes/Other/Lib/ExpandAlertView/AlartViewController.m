...
{
    UIView *positiveView;// 确定
    UIView *negativeView;// 不确定
    UIButton *cancelButton;// 取消操作
    UILabel *titleLabel; // 提示信息
...
- (void)viewDidLoad
{
    ...
    cancelButton = [[UIButton alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width * 0.5 - 15, 600, 30, 30)];
